...
class GOTURNMomentum(Tracker):
    ...
    """
    def __init__(self):
        super(GOTURNMomentum, self).__init__(
            name='GOTURN_momentum', # name of the tracker
    ...
    def update(self, image):
        """Locate target in  new frame and return the estimated bounding box.
